import "./style.css";
import "./imgs/paper.png";
import "./imgs/scissors.png";
...
btnWinner.addEventListener("click", () => {
  ...
  p1Score.innerHTML = score1;
  p2Score.innerHTML = score2;
  cmpChoice.setAttribute("src", "./imgs/rock.png");
  p1Choice.setAttribute("src", "./imgs/rock-left.png");
});
...
function battle(p1) {
  ...
  if (power1 == 1 && cpupower == 1) {
    ...
    document
      ...
      .setAttribute("src", "./imgs/rock.png");
  } else if (power1 == 1 && cpupower == 2) {
    // rock vs scissor
    result = "win";
    document
      .querySelector("#computerchoice")
      .setAttribute("src", "./imgs/scissors.png");
  } else if (power1 == 1 && cpupower == 3) {
    // rock vs paper
    document
      .querySelector("#computerchoice")
      .setAttribute("src", "./imgs/paper.png");
    result = "lose";
  }
